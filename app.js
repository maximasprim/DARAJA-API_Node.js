...
async function getAccessToken() {
  const consumer_key = "YHLA3w9UOwfyOeWekGQwCroILkJyRcXbeG4y71fshM2wwbS3"; // REPLACE IT WITH YOUR CONSUMER KEY
  const consumer_secret = "9aAyGCTPm4dk5QosA5ANupcwpL2GdCKu43vdpxsN0DQYePLeo2kUSiMO5812vIWN"; // REPLACE IT WITH YOUR CONSUMER SECRET
  const url =
...
app.get("/", (req, res) => {
  res.send("MPESA DARAJA API WITH NODE JS BY MAXIMAS@PRIME");
